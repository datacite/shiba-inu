...
gem "logstash-input-elasticsearch", :path => "/usr/share/logstash/plugins/logstash-input-elasticsearch"
gem "paquet", "~> 0.2.0"
...
gem "logstash-codec-json", ">= 0"
gem "logstash-codec-json_lines", ">= 0"
gem "logstash-codec-line", ">= 0"
gem "logstash-codec-msgpack"
gem "logstash-codec-multiline", ">= 0"
...
gem "logstash-input-generator", ">= 0"
